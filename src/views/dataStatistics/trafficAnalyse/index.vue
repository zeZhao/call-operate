...
<!-- 分时话务分析 -->
  <div class="trafficAnalyse">
    ...
    >
      ...
      <el-table-column prop="connTime" label="时段" >
        <template slot-scope="{row}">
          <span>{{row.connTime | dateTime}}</span>
        </template>
      </el-table-column>
      <el-table-column prop="attendName" label="呼入总数" />
      ...
      <el-table-column prop="talkDuration" label="15s接通数" />
      <el-table-column prop="talkDuration" label="15s接通率" />
      <el-table-column prop="talkDuration" label="呼入时长" />
