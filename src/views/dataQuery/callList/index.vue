<template>
  <div class="company">
    ...
    >
      ...
      <el-table-column prop="corpId" label="计费账户" />
      ...
      <el-table-column prop="corpId" label="计费时长" />
      <el-table-column prop="corpId" label="通话费用" />
      <el-table-column prop="corpId" label="通话成本" />
